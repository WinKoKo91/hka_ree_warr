...
class DarkColor {
  ...
  static const Color titleTextColor = const Color(0xffffffff);
  static const Color subtitleTextColor = const Color(0xffededed);
  ...
  static const Color iconColor = Color(0xffE1E2E4);
